...
from core.repos import AbstractChatRepo, AbstractChatGroupRepo, AbstractParticipantRepo, AbstractUserRepo, AbstractMessageRepo, AbstractReplyRepo
...
class MessengerUoWFactory:
    def __init__(
        ...
        reply_repo_class: type[AbstractReplyRepo],
    ):
        ...
        self.reply_repo_class = reply_repo_class
    ...
    def __call__(self) -> MessengerUnitOfWork:
        return MessengerUnitOfWork(
            ...
            self.reply_repo_class(auto_commit=False),
        )
...
class MessengerUnitOfWork:
    def __init__(
        ...
        reply_repo: AbstractReplyRepo | None = None,
    ):
    ...
    def __enter__(self):
        ...
        self.reply_repo._session = self._session
        return self
